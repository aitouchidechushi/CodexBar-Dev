...
pub fn tray_tooltip_credits(lang: Language, provider_name: &str, credits_percent: f64) -> String {
...
locale_keys! {
    ...
    InterfaceLanguage,
    StartupSettings,
    FloatingBallSectionTitle,
    FloatingBallShow,
    FloatingBallShowHelper,
    KimiMonthlySectionTitle,
    KimiMonthlyQuotaShow,
    KimiMonthlyQuotaShowHelper,
    KimiMonthlyConsentMessage,
    TabKimiAccounts,
    KimiAccountsDescription,
    KimiBrowserDescription,
    KimiBrowserConsentMessage,
    KimiBrowserRefresh,
    KimiBrowserNoAccount,
    KimiAccountAdd,
    KimiAccountFinishLogin,
    KimiAccountCancelLogin,
    KimiAccountRemove,
    KimiAccountLoginRequired,
    KimiAccountRelogin,
    KimiAccountRefreshFailed,
    KimiAccountStorageError,
    KimiAccountLoginHint,
    KimiAccountReadingInBackground,
    KimiAccountMonthlyQuota,
    KimiAccountLinkedApiKeys,
    KimiAccountUnlinkedApiKeys,
    KimiAccountResetTime,
    StartAtLogin,
    StartMinimized,
    StartAtLoginHelper,
    ...
    ApiKeyLabelFor,
    ApiKeySaveLabelAction,
    ApiKeyReplaceSecret,
    ApiKeyReplaceSecretAction,
    ApiKeyShowSecret,
    ApiKeyHideSecret,
    ApiKeyReplacementFor,
    ApiKeySaveReplacementAction,
    ApiKeyDelete,
    ApiKeyDeleteAction,
