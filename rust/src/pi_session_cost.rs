...
mod tests {
    ...
    fn dedupes_shared_entry_ids_across_files() {
        ...
        let sample_timestamp = Utc::now();
        assert!(
            sample_timestamp >= Utc::now() - Duration::days(30),
            "dedupe fixture must remain inside the 30-day scan window"
        );
        let line = serde_json::json!({
            ...
            "provider": "openai-codex",
            "model": "gpt-5",
            "timestamp": sample_timestamp.to_rfc3339(),
