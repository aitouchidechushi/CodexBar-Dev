...
import { TRAY_HOVER_WINDOW_LABEL } from "./tray-hover/api";
...
const TrayHover = lazy(() => import("./tray-hover/TrayHover"));
...
/** True when running inside the non-activating tray hover window. */
function isTrayHoverWindow(): boolean {
  return getCurrentWebviewWindow().label === TRAY_HOVER_WINDOW_LABEL;
}
