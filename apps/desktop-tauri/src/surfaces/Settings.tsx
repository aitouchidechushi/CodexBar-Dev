...
import KimiAccountsTab from "./settings/tabs/KimiAccountsTab";
...
const TabIcons: Record<SettingsTab, ReactElement> = {
  ...
  kimiAccounts: (
    <Svg>
      ...
      <path d="M1.8 13c.7-2.6 2.1-3.8 4.2-3.8s3.5 1.2 4.2 3.8M10.5 5.5h3.7M12.35 3.65v3.7" />
    </Svg>
  ),
  providers: (
    <Svg>
...
export const TAB_META: { id: SettingsTab; labelKey: LocaleKey }[] = [
  ...
  { id: "kimiAccounts", labelKey: "TabKimiAccounts" },
  ...
  return (
    ...
    >
      ...
      <div className={`settings-body${activeTab === "providers" ? " settings-body--providers" : ""}`}>
        ...
        {activeTab === "kimiAccounts" && (
          <KimiAccountsTab
            enabled={settings.kimiMonthlyQuotaEnabled ?? false}
            browserConsentAccepted={settings.kimiBrowserConsentAccepted ?? false}
          />
        )}
        {activeTab === "providers" && (
          <ProvidersTab
